...
- Image Gallery with Lightbox: The 'About Us' page now includes an image gallery with a lightbox feature for viewing images in detail.
- Embedded Google Map: The 'Contact Us' page now features a responsive, embedded Google Map to help users locate the organization.
- Contact and Enquiry Forms: Implemented forms on the 'Contact Us' and 'Enquiry' pages with client-side validation and simulated AJAX submission for improved user interaction.
- SEO Enhancements: Improved search engine optimization through the creation of `robots.txt` and `sitemap.xml`, addition of meta descriptions to all pages, and more descriptive alt text for images.
- Dynamic Content Animations: Added fade-in animations for content sections to enhance the user experience.
...
## Changelog
- 2025-11-19: Implemented contact and enquiry forms with client-side validation and simulated AJAX submission.
- 2025-11-19: Created robots.txt and sitemap.xml for improved SEO.
- 2025-11-19: Added meta descriptions to all HTML pages and improved image alt text for better accessibility and SEO.
- 2025-11-19: Added fade-in animations for content sections to enhance user experience.
- 2025-11-19: Added a responsive Google Map to the 'Contact Us' page.
- 2025-11-19: Added a new 'Gallery' section to the 'About Us' page with lightbox functionality.
